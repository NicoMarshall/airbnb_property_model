...
def model_search(model_list: list, hyper_dicts: list):
    #for model_class, model_name, hyperparams in zip(model_list, model_names, hyper_dicts):
    model_class, model_name, hyperparams = ensemble.RandomForestRegressor, "Random Forest", hyperparam_dict_random_forest
